    ...
    <section class="">
        ...
        if (@$_GET['chat_id']) { ?>
            <div class="row navbar navbar-default" style="width: 100%; margin-left: 0px; background-color: #e5e5e5; border: 2px solid white; border-left: none; position:fixed; bottom:0; height:70px;">
                <input type="text" id="chat-" name="message" autocomplete="off" class="form-control col-md-7 col-8 mr-md-5 message" placeholder="Type a message ..." style="background-color: #e5e5e5;">
